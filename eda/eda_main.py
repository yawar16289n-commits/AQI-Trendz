...
Focuses on 6 key explorations treating all 5 pollutants equally.

Data Source: Hopsworks Feature Store (aqi_weather_features v1, ~33k rows)
Output:      eda_plots/
"""
...
def save(fig, filename):
    ...
    plt.close(fig)
    print(f"  Saved → eda_plots/{filename}")
...
# ══════════════════════════════════════════════════════════════════════════════
# 6 ADVANCED EXPLORATIONS
# ══════════════════════════════════════════════════════════════════════════════
def run_eda(df):
    print("\nGenerating 6 Advanced Multi-Pollutant EDA Visualizations...")
    ...
    # Find which pollutant has the highest ratio to its WHO limit for each hour
    ...
    # PM2.5 vs PM10 (Dust/Smog Signature)
...
if __name__ == "__main__":
    ...
    run_eda(df)
    print("\n" + "-" * 65)
    print("  EDA Complete! All plots saved directly to eda_plots/")
    print("-" * 65)
